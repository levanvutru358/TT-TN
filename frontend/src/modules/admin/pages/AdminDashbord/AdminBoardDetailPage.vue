...
import ConfirmModal from '@/modules/admin/components/AdminDashbord/common/ConfirmModal.vue'
import BoardMembersTable from '@/modules/admin/components/AdminDashbord/board/BoardMembersTable.vue'
