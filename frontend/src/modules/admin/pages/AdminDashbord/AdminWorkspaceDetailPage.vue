...
import WorkspaceMembersTable from '@/modules/admin/components/AdminDashbord/workspace/WorkspaceMembersTable.vue'
import WorkspaceBoardsTable from '@/modules/admin/components/AdminDashbord/workspace/WorkspaceBoardsTable.vue'
