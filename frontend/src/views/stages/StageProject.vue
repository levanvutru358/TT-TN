<template>
  ...
  <main
      ref="boardWrapper"
      class="relative flex-1 p-3 md:p-4 overflow-hidden
      rounded-[26px] bg-[#0b0f19] border border-black/60
      shadow-[0_20px_60px_rgba(0,0,0,0.65)]"
    >
      <div
        class="h-full w-full overflow-auto rounded-[22px]
        bg-gradient-to-r from-[#4b3f72] via-[#7b3ea8] to-[#c1558b]
        hide-scrollbar"
      >
